      ...
      <div className="px-4 py-8">
        <div className="max-w-md mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center bg-brand-accent text-brand-primary px-6 py-3 rounded-lg font-medium hover:bg-brand-gold hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-brand-accent/30 mb-4"
          >
